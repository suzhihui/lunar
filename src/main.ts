...
let formartDayD4 = (month:number|string, day:number|string) => {
 ...
 * 从0小寒起算
 */
let termInfo = [0,21208,42467,63836,85337,107014,128867,150921,173149,195551,218072,240693,263343,285989,308563,331033,353350,375494,397447,419210,440795,462224,483532,504758];
 ...
 * return 闰月数 （月份从1开始）
 */
const getLunarLeapYear = (year:number):string|number => {
 ...
 * @param {Number} year 农历年
 */
const getLunarYearDays = (year:number):any => {
  var yearData = lunarInfo[year-minYear];
  var leapMonth = yearData[0]; //闰月
  var monthData = yearData[3].toString(2);
  var monthDataArr:any = monthData.split('');
  ...
  let len = leapMonth ? 13 : 12; //该年有几个月
  let yearDays = 0;
  let monthDays = [];
  for(var i=0;i<len;i++){
    if(monthDataArr[i]==0){
...
const getLunarDateByBetween = (year:number, between:number) => {
